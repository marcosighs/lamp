(Pt-BR) Olá! Esta página tenta simular o comportamento de uma lâmpada com algumas configurações de interatividade, onde é possível para o usuário apagar, ascender ou quebrar a lâmpada.
